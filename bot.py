...
# Импортируем requests для проверки токена Telegram
import requests
...
# Импортируем types для кнопок Telegram
from telebot import types

# Импортируем Update для webhook-обновлений
from telebot.types import Update

# Импортируем PdfReader для чтения PDF
from PyPDF2 import PdfReader

# Импортируем PdfWriter для записи отдельных PDF-файлов
